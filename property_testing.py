...
def test_path_starts_and_ends_correctly(data):
  """
  Verify that the path returned by A* starts and ends at the correct grid positions.
  """
  sx, sy, gx, gy = data
...
def test_path_avoids_obstacles(obstacles):
  """
  Ensure that the path generated by A* does not intersect any obstacles.
  """
...
def test_path_cost_is_monotonic():
  """
  Verify that the cumulative cost along the A* path increases monotonically.
  """
  ox = [100.0]
  oy = [100.0]
